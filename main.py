...
# --- ИНИЦИАЛИЗАЦИЯ БОТА (Твои переменные для start_services) ---
...
# Добавил явные роуты для твоих страниц, чтобы не было 404
...
# --- ЧИСТЫЙ ЗАПУСК (ТВОЯ ЛОГИКА) ---
async def start_services():
    print("🤖 Бот SpeechClone запускается...")
    asyncio.create_task(dp.start_polling(bot))
    
    import uvicorn
    # Убираем ручной порт, Рендер сам всё разрулит
